...
def main():
    ...
    prev_df =  spark.read\
            ...
            .options(table=TABLE_NAME, keyspace="advertise")\
            .load()
    ...
    session.execute('CREATE TABLE test (userid text, categoryid text, searches set<text>, PRIMARY KEY ((userid, categoryid)))')
    cluster.shutdown()
