...
class Consumer(object):
    ...
    def flush_to_hdfs(self, output_dir):
        ...
        hdfs://user/directed-advertising/history and
        hdfs://user/directed-advertising/cached
...
if __name__ == '__main__':
    ...
    print "Consuming logs from web_activity1 topic: . . ."
    cons = Consumer(addr="localhost:9092", group="hdfs", topic="web_activity1")
    cons.consume_topic("/home/ubuntu/directed-advertising/kafka_consumer/")
